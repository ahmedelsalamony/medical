package com.example.ahmed.medical.MangmentAndDepartment.JobsName.adapters;
...
import com.example.ahmed.medical.MangmentAndDepartment.JobsName.modles.JobsNameControl;
import com.example.ahmed.medical.R;

import java.util.List;

public class JobsNamesAdapter extends RecyclerView.Adapter<JobsNamesAdapter.MyViewHolder> {

    private List<JobsNameControl> displayList;

    public JobsNamesAdapter(List<JobsNameControl> displayList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        JobsNameControl disUserControl = displayList.get(position);
