...
public class ActivityUsersControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_control);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Insert_UsersControl(), "اضافة جديد");
        adapter.addFrag(new Display_UserControl(), "قائمة البيانات");
